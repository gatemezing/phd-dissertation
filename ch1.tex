...
\section{Lessons Learned from Modeling Geospatial vocabularies}
\label{sec:bpgeo}
...
\section{CRS requirements for the  French territory} \label{sec:reqs}
