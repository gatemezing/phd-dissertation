...
\label{sec:toolLD}
In this section, we discuss existing tools that manage the workflow of publishing geodata on the Web. To the best of our knowledge, \textsc{GeoKnow} and \textsc{Geoknow Stack} are currently two tools providing such functionality to publishers. 
...
\subsection{Comparison between Geoknow and Datalift}
