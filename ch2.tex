...
Regarding the interconnection with more existing geodata, first results of mappings using LIMES for amenities in three big cities of France (Paris, Lyon and Marseille) (cf. Table \ref{tab:bano-gld}) shows the low presence of the addresses for French territory. All the results of the mappings are available at \url{https://github.com/gatemezing/bano2rdf-matching}. What it also
