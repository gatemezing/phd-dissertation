...
\lstset{basicstyle=\scriptsize, backgroundcolor=\color{white}, frame=shadowbox, caption= {the metadata used in the BANO2RDF dataset.}, language=json, label=scriptLIMES, captionpos=b}
\begin{lstlisting}
