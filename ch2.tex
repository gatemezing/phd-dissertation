...
Regarding the interconnection with more existing geodata, first results of mappings using LIMES for amenities in three big cities of France (Paris, Lyon and Marseille) (cf. Table \ref{tab:bano-gld}) shows the low presence of the addresses for French territory. All the results of the mappings are available at \url{https://github.com/gatemezing/bano2rdf-matching}. 
...
\begin{table}[ht!b]
        ...
        \begin{tabular}{|c|c|c|c|c|c|c|}
           ...
           \multirow{2}{*}{LGData Amenities}  & \multicolumn{2}{|p{2cm}|}{Bano-750xx (248,052)} & \multicolumn{2}{|p{2cm}|}{Bano-130xx (401,404)} & \multicolumn{2}{|p{2cm}|}{Bano-690xx (89,061)}\\
            ...
            \hline
            \multicolumn{1}{|p{2cm}|}{PlaceOfWorship (357,445)} & 272 & * & 193 & * & 31 & *  \\
            \hline
            \multicolumn{1}{|p{2cm}|}{Restaurant (260,675)} & 13,567 & * & 2,654 & * & 1,882 & *  \\
            \hline
            \multicolumn{1}{|p{2cm}|}{PublicBuilding (26,735)} & 97 & * & 64 & * & 21 & *  \\
            \hline
            \multicolumn{1}{|p{2cm}|}{PostOffice (87,731)} & 971 & * & 555 & * & 173 & *  \\
            \hline
        \end{tabular}
