...
\paragraph{}
We have made the assumption in this thesis that access to data was either by  querying a SPARQL endpoint, or by browsing or by downloading the dumps. Recently, it is emerging a new way of accessing the data on the Web: through the triple pattern fragments\footnote{\url{http://linkeddatafragments.org/}}. Linked Data Fragments \cite{verborgh2014ldf} aims at exploring interfaces to 
...
\todo{add a paragraph for datalift and best practices}
