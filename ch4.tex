...
\begin{itemize}
\item Tools for visualizations: facete, soA, etc.
\item Survey on visualizations applications
...
\texttt{Supported Platform} &	Web \\ \hline
	& http://{BASE}/en/{NAME-CHART}.php.\\
\texttt{URL Policy}                   &  e.g:  http://{BASE}/en/toppayersday.php \\ \hline
