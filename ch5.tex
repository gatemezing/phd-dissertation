...
We have implemented a vocabulary, DVIA\footnote{\url{http://bit.ly/Vb4L8k}} aims at describing any applications developed to consume datasets in 4-5 stars, using visual tools to showcase the benefits of Linked Data. It reuses four existing vocabularies: Dublin Core terms\footnote{\url{http://purl.org/dc/terms/}}, dataset catalogue (DCA)\footnote{\url{http://www.w3.org/ns/dcat#}}, Dublin Core Metadata Initiative\footnote{\url{http://purl.org/dc/dcmitype}} and the Organization vocabulary \footnote{\url{http://www.w3.org/ns/org#}}.  It is composed of three main classes : 
