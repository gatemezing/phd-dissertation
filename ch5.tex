...
In order to build the application, we had to look at some relevant datasets in \utl{data.gouv.fr}. The ones selected for building the application are the following:
